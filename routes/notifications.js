 ...
 */
async function createNotification({ userId, title, message, type = 'info', link = null, metadata = null }) {
  try {
    await db.query(
...
router.post('/', async (req, res) => {
  try {
    const { user_id, title, message, type = 'info', link = null, metadata = null } = req.body;
